...
<body class="container mt-4">
  ...
  <div class="alert alert-warning">
    <strong>ℹ️ Perhatian:</strong> Halaman ini akan mengirimkan notifikasi otomatis melalui WhatsApp jika nomor WA telah terisi. 
    Untuk menghindari spam dan blokir, silakan gunakan <b>WhatsApp Bisnis</b>, dan pastikan Orang Tua/Wali Siswa sudah menyimpan nomor WA yang sedang digunakan ini.
  </div>
  <!-- ✅ Akhir tambahan -->
  ...
  <script>
    function onScanSuccess(qrMessage) {
      fetch("rekam_absen.php?nisn=" + qrMessage)
        .then(res => res.json())
        .then(data => {
